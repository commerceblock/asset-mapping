...
with open('tx_us.json','r') as file:
...
with open("tx_ps.json",'w') as file:
...
map_obj.export_json("map_ps.json")

print("Partially signed objects exported to map_ps.json and tx_ps.json in directory "+os.getcwd())
